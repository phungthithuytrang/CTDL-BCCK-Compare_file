...
int main()
{
	...
	outfile2.open("E:\\CTDL\\CTDLProject\\Test ct\\Simulate\\kq.txt", ios::out | ios::trunc);
	outfile1.open("E:\\CTDL\\CTDLProject\\Test ct\\Simulate\\timecompare.txt", ios::out | ios::trunc);
