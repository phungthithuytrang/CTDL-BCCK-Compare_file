...
int main()
{
	outfile1.open("E:\\CTDL\\CTDLProject\\Test ct\\Simulate\\docAVL.txt", ios::out | ios::trunc);
	outfile2.open("E:\\CTDL\\CTDLProject\\Test ct\\Simulate\\sosanhAVL.txt", ios::out | ios::trunc);
