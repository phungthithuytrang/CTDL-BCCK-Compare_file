...
int main()
{
	outfile1.open("E:\\CTDL\\CTDLProject\\Test ct\\Simulate\\docBTree.txt", ios::out | ios::trunc);
	outfile2.open("E:\\CTDL\\CTDLProject\\Test ct\\Simulate\\sosanhBTree.txt", ios::out | ios::trunc);
