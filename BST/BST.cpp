...
int main()
{
	outfile1.open("E:\\CTDL\\CTDLProject\\Test ct\\Simulate\\docBST.txt", ios::out | ios::trunc);
	outfile2.open("E:\\CTDL\\CTDLProject\\Test ct\\Simulate\\sosanhBST.txt", ios::out | ios::trunc);
